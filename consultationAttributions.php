...
{
   echo "
   <table width='75%' cellspacing='10' cellpadding='0' align='center'
   <tr><td>
   ...
   while($lgEtab!=FALSE)
   {
      ...
      echo "
      <table width='75%' cellspacing='0' cellpadding='10' align='center' 
      class='tabQuadrille'>";
      ...
      <tr class='ligneTabQuad'>
         <td width='55%' align='left'><i><strong>Nom groupe</strong></i></td>
         <td width='35%' align='left'><i><strong>Chambres attribuées</strong></i></td>
		 <td width='35%' align='left'><i><strong>Pays d'origine</strong></i></td>
      ...
      while($lgGroupe!=FALSE)
      {
         ...
         echo "
            <td width='30%' align='left'>$nbOccupGroupe</td>
